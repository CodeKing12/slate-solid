...
export const EDITOR_TO_PLACEHOLDER_ELEMENT: WeakMap<Editor, HTMLElement> = new WeakMap();
...
export const EDITOR_TO_PENDING_INSERTION_MARKS: WeakMap<Editor, Partial<Text> | null> = new WeakMap();
...
export const EDITOR_TO_PENDING_DIFFS: WeakMap<Editor, TextDiff[]> = new WeakMap();

export const EDITOR_TO_PENDING_ACTION: WeakMap<Editor, Action | null> = new WeakMap();
...
export const MARK_PLACEHOLDER_SYMBOL = Symbol("mark-placeholder") as unknown as string;
