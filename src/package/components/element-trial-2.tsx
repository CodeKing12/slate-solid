...
const Element = (props: ElementComponentProps) => {
	...
	let children: JSX.Element = (
		<Key
			...
			by={(_, index) => SolidEditor.findKey(editor, merge.element.children[index])}
		>
			{(reactiveNode, index) => {
				NODE_TO_INDEX.set(merge.element.children[index()], index());
				NODE_TO_PARENT.set(merge.element.children[index()], merge.element);
